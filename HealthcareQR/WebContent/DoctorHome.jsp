...
<!DOCTYPE html>
	...
	{
	out.println("<script>alert('Login Sucessful...Welcome to Doctors Section ...!')</script>");	
	}
   %>
    <header id="header">
			...
			<section class="appointment-area">			
				<div class="container">
					...
					<h2 align="center">Welcome <%=session.getAttribute("username") %> to Doctor Section</h2>	<br>
		        <table align="center">
					<tr>
					 <td>
					 <img src="images/doctor.jpg" width="90" height="100">&nbsp;&nbsp;&nbsp;</td>
					 <td><span style="font-size:22px; color: red">Doctor Section</span></td>
					 </tr>
            	</table><br>			
				<h3 align="center">"Eat Apple A Day Keeps Doctor Away"</h3>
			<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

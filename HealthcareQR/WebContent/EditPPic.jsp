   ...
   %>
     <header id="header">
            ...
            <table style="border: 3px solid red" align="center" border="10" width="350px" height="50px" cellpadding="10px">
					...
					<tr class="noBorder">	
					 	<td align="center"><form action="ProfilePicture" method="post" enctype="multipart/form-data">
       						<input type="file" name="file" id="file" required>
        					<input class="button" type="submit" value="Change" style="height: 32px; width:82px;">
        					</form></td>
					 	<td align="center"><h2><b><%=session.getAttribute("pfname")%>&nbsp;<br><%=session.getAttribute("plname")%></b></h2></td>
					</tr>
            </table>
           </div>
		</div>

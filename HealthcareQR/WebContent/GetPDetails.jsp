   ...
   %>
     <header id="header">
			...
			<table align="center">
				<tr>
				<td>
				 <img src="images/insu.png" width="90" height="90">&nbsp;&nbsp;&nbsp;</td>
				 <td><span style="font-size:22px; color: red">Welcome to Inurance Section</span></td>
				 </tr>
            </table><br>
            
            <form action="InsuAuthentication" method="post">		
            <table style="border: 3px solid red" align="center" border="10" width="350px" height="50px" cellpadding="10px">
					<tr align="center" class="noBorder">
						<td><span style="font-size:22px; color: red">Patient Smart Card Id</span></td>						
						<td rowspan="3"><img src="images/patient.jpg" width="60px;" height="60px"></td>
					</tr> 
					<tr>
						<td><input type="text" name="SmartCardNo" id="SmartCardNo" placeholder="Enter Patients Smart Card No."></td>
					</tr>
					<tr class="noBorder">	
					 	<!-- <td align="center"><input type="file" name="username" id="username" required></td> -->
        				<td align="center"><input class="button" type="submit" value="Submit" style="height: 32px; width:142px;"></td>
					 </tr>
            		</table>
            	</form>	
				</div>

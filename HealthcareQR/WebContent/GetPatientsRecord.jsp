     ...
     <header id="header">
			...
			<section class="appointment-area">			
				<div class="container">
		            ...
		            <h2 align="center" class="mb-2" style="font-size: 32px;">Insurance Section</h2>
	          
	          	<form action="PatientsCheckup" method="post" >
				...
				%>
					<tr align="center">
						...
						<td colspan="3"><span style="font-size:20px; color: red">Mr./Ms. <b><%=rs.getString("pfname") %>&nbsp;<%=rs.getString("plname") %>'s</b> Profile History </span></td>
					</tr>
		            <tr align="center">
		            <th><b>Smart Card No.</b></th>
						<td><%=rs.getString("SmartCardNo") %><%session.setAttribute("SmartCardNo", rs.getString("SmartCardNo"));%></td>
					<th><b>Name</b></th>	
					...
					<th><b>Action</b></th>
					<td align="center"><input type="submit" value="View Records" style="font-size:large; 75px; height: 38px; width:135px;"></input></td>
					</tr>
            <%
				}
			%>

...
<!DOCTYPE html>
  ...
  <body>
	...
	{
	out.println("<script>alert('Congratulation...Hospital Registration Sucessfully Completed ...!')</script>");	
	}
   %>
     <header id="header">
			      ...
			      <div id="logo">
					...
					<nav id="nav-menu-container">
				        <ul class="nav-menu">
				        	...
				        	<li class="nav-item active"><a href="Hospital.jsp" class="nav-link">Hospital</a></li>
			...
			<section class="appointment-area">			
		        ...
		        <table align="center">
					<tr>
					 ...
					 <td><span style="font-size:22px; color: red">Hospital Login</span></td>
					 </tr>
            	</table>			
			...
			<form action="Hospital" method="post">
				<table align="center" border="0" width="50" cellpadding="5" cellspacing="5">
					...
					<tr>
				     	...
				     	<td><a href="HospitalRegister.jsp">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/adduser.png" width="50" height="50" alt=""></img></a></td>
				     </tr>
				</table>
			</form><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

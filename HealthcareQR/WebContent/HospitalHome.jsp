...
<!DOCTYPE html>
  ...
  <%
	...
	{
		out.println("<script>alert('Login Sucessful .. Welcome to City Hospital')</script>");	
	}
  
  	if(request.getParameter("done")!=null)
	{
		out.println("<script>alert('Doctor Registration Sucessful .... ')</script>");	
	}
  	
  	if(request.getParameter("add")!=null)
	{
		out.println("<script>alert('Insurance Company Registration Sucessful .... ')</script>");	
	}
   %>
   <%
	if(request.getParameter("Done")!=null)
	{
		out.println("<script>alert('Congratulations .. Patient Registration & QR Code Successfully Done')</script>");	
	}
   %>
     <header id="header">
			...
			<table align="center">
				...
				<td>
				 ...
				 <td><span style="font-size:22px; color: red">Welcome to City Hospital</span></td>
				 </tr>
            </table><br>			

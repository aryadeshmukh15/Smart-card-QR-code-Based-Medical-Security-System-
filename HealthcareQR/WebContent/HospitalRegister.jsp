			      ...
			      <div id="logo">
					...
					<nav id="nav-menu-container">
				        <ul class="nav-menu">
				        	...
				        	<li class="nav-item active"><a href="Doctor.jsp" class="nav-link">Doctor</a></li>
		...
		<section class="appointment-area">			
			<div class="container">
		        ...
		        <table align="center">
					<tr>
					 <td>
					 <img src="images/hospital.jpg" width="70" height="60">&nbsp;&nbsp;&nbsp;</td>
					 <td><span style="font-size:22px; color: red">Hospital Registration</span></td>
					 </tr>
            	</table>			
		
			<form action="HospitalRegister" method="post"  onsubmit="return validate()">
            <table align="center" border="5" cellpadding="9px" cellspacing="9px">
            <tr>
	            <td><strong>Hospital Name</strong></td><td><input type="text" name="hname" id="hname"></input></td>
	            <td><strong>Sub Name</strong></td><td><input type="text" name="sname" id="sname"></input></td>
            </tr>
            
            <tr>
	            <td><strong>Specialist</strong></td><td><select name="specialist" id="specialist">

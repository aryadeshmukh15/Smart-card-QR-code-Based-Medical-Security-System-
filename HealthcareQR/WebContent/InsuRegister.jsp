	...
	<body>
     <header id="header">
			      ...
			      <div id="logo">
					...
					<nav id="nav-menu-container">
				        <ul class="nav-menu">
				        	...
				        	<li class="nav-item active"><a href="InsuRegister.jsp" class="nav-link">Insurance Section</a></li>
		...
		<section class="appointment-area">			
			...
			<h2 align="center">Welcome to Doctor Section</h2>
			
		        <table align="center">
					<tr>
					 <td>
					 <img src="images/insur.jpg" width="70" height="60">&nbsp;&nbsp;&nbsp;</td>
					 <td><span style="font-size:22px; color: red">Insurance Company Registration</span></td>
					 </tr>
            	</table>			
		
			<form action="InsuRegister" method="post"  onsubmit="return validate()">
            <table align="center" border="5" cellpadding="12px" cellspacing="12px">
            <tr>
	            <td><strong>Company Name</strong></td><td><input type="text" name="cname" id="cname"></input></td>
	            <td><strong>Sub Name</strong></td><td><input type="text" name="sname" id="sname"></input></td>
            </tr>
              
            <tr>
	            <td><strong>Domain</strong></td><td><select name="domain" id="domain">
       								<option>--------Select-------</option>
       								<option value="General">General Insurance</option>
        							<option value="Medical">Medical Insurance</option>
        							<option value="Vehical">Vehical Insurance</option>
            ...
            <tr>
	            ...
	            <td><strong>Contact No.</strong></td><td><input type="text" name="contact" id="contact" maxlength="10"></input></td>
            </tr>

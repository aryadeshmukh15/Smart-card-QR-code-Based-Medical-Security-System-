     ...
     <header id="header">
			      ...
			      <div id="logo">
					...
					<nav id="nav-menu-container">
				     <ul class="nav-menu">
			        	...
			        	<li class="nav-item active"><a href="Insurance.jsp" class="nav-link">Insurance</a></li>
			...
			<section class="appointment-area">			
				<div class="container">
					...
					<h2>Welcome to Insurance Section</h2>	<br>
		        <table align="center">
					<tr>
					 <td>
					 <img src="images/insur.jpg" width="70" height="60">&nbsp;&nbsp;&nbsp;</td>
					 <td><span style="font-size:22px; color: red">Insurance Dept. Login</span></td>
					 </tr>
            	</table>			

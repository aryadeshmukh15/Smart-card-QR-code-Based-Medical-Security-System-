...
<!DOCTYPE html>
	...
	{
	out.println("<script>alert('Login Sucessful...Welcome to Insurance Dept. ...!')</script>");	
	}
   %>
     <header id="header">
			...
			<section class="appointment-area">			
				<div class="container">
					...
					<h2>Welcome <%=session.getAttribute("username") %> to Insurance Dept.</h2>	<br>
		        <table align="center">
					<tr>
						 <td><img src="images/insur.jpg" width="70" height="60">&nbsp;&nbsp;&nbsp;</td>
						 <td><span style="font-size:22px; color: red">Insurance Department</span></td>
					</tr> 
					<tr>
					 	<td colspan="2" align="center"><button class="button"><a href="GetPDetails.jsp"><font color="black"><b>Patients Health Record</b></font></a></button>			</td>
					 </tr>
            	</table><br>
			<h3 align="center">"The thing they're trying to stop is 30-million people getting health insurance. That's the substance."
			<br><br>-- Chris Hayes</h3>
			<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;

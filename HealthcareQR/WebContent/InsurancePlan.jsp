...
<!DOCTYPE html>
  ...
  <%
	...
	{
	out.println("<script>alert('Patients Insurance Info Stored Sucessful.....!')</script>");	
	}
	if(request.getParameter("present")!=null)
	{
	out.println("<script>alert('Patients Insurance Info Already Stored .....!')</script>");	
	}
   %>
     <header id="header">
		    	...
		    	<div class="row align-items-center justify-content-between d-flex">
			      <div id="logo">
					...
					<nav id="nav-menu-container">
				        <ul class="nav-menu">
				        	<li class="nav-item active"><a href="InsuranceHome.jsp" class="nav-link pl-0">Home</a></li>
				        	<li class="nav-item"><a href="GetPDetails.jsp" class="nav-link">Patients</a></li>
			...
			<section class="appointment-area">			
				<div class="container">
					<div class="row justify-content-between align-items-center pb-120 appointment-wrap">
						...
						<div align="center"><h4>Insurance Information</h4></div>
		        ...
		        <table align="center" border="10" cellpadding="10px" cellspacing="0px">
              	...
              	<%		
						...
						PreparedStatement ps=con.prepareStatement("select * from insurance where username=?");
				...
				%>
		            <tr>
		            	<th colspan="2"><b>Insurance Plan for Patient</b></th>
		           		<th><b>Smart Card No.</b></th>
		            </tr>
		             <tr align="center">
			            <th colspan="2"><b><%=email %></b></th>
			            <th><b><input type="text" class="form-control" name="SmartCardNo" value="<%=SmartCardNo %>" readonly="readonly"></b></th>
					</tr>
					<tr align="center">
			            <th colspan="3"><b>Insurance Company Information:-</b></th>
					</tr>
					<tr>
						<td>Company Name</td>
						<td>Email Address</td>
					...
					<tr>
						<td><input type="text" class="form-control" name="txtcompany"
							value="<%=rs.getString("cname") %> <%=rs.getString("sname") %>" readonly="readonly"></td>
						<td><input type="text" class="form-control" name="txtemail"
							value="<%=rs.getString("email") %>" readonly="readonly"></td>
						<td><input type="text" class="form-control" name="txtmobile"
							value="<%=rs.getString("contact") %>" readonly="readonly"></td>
					</tr>
					<tr align="center">
			            <th colspan="3"><b>Insurance Form Details:-</b></th>
					</tr>
					<tr>
						<td>Policy No.</td>
						<td>Policy Name</td>
						<td>Policy_Tenue(Yr)</td>
					</tr>
					<tr>
						<td><input type="text" class="form-control" required="required" name="txtpolicyno"></td>
						<td><input type="text" class="form-control" required="required" name="txtpolicename"></td>
						<td><input type="text" class="form-control" required="required" name="txtpolicytenue"></td>
					</tr>
					<tr>
						<td>Base_Premium</td>
						<td>Coverage</td>
					...
					<tr>
						<td><input type="text" class="form-control" required="required" name="txtbasepremium"></td>
						<td><input type="text" class="form-control" required="required" name="txtCoverage"></td>
						<td><input type="text" class="form-control" required="required" name="txtamount"></td>
					</tr>		
		            <tr>
						<td align="center" colspan="3"><input class="button" type="submit" value="Submit Info" style="height: 32px; width:155px;"></td>
					</tr>
					<%
						}
					%>

...
<body>
  <%
	...
	out.println("<script>alert('Login Sucessful .. Welcome to Patient Section')</script>");	
  	...
  	if(request.getParameter("apdone")!=null)
	{
	out.println("<script>alert('Appointment Book Sucessfully.......Wait for Acceptance')</script>");	
	}
   %>
   <header id="header">
			...
			<table align="center">
				...
				<td>
				 ...
				 <td><span style="font-size:22px; color: red">Welcome to Patient Home</span></td>
				 </tr>
            </table>
            		<%
						...
						{
					%>
			<h3 align="center">Patient's Smart Card</h3>
			<div class="rcorners1" align="center">
            <table align="center" width="350px" height="50px" cellpadding="5px">
					
					<tr align="center">
						<td><span style="font-size:22px; color: red">QR Code</span><br>
						<b><%=session.getAttribute("SmartCardNo")%></b></td>
						<td><a href="EditPPic.jsp"><img src="ProfilePicture/<%=rs.getString("ppicture") %>" width="70px;" height="70px"></a></td>
					</tr> 
					<tr>	
					 	<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="QRCode/<%=username%>.png" align="center" style="width: 120px" height="120px"/></td>
					 	<td align="center"><h2><b><%=rs.getString("pfname")%>&nbsp;<br><%=rs.getString("plname")%></b></h2></td>
					</tr>
					 <%
				}
			%>

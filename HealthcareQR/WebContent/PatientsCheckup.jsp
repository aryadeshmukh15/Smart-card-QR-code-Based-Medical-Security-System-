    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-start align-items-center px-3 px-md-0">
    			<div class="col-md-4 order-md-2 mb-2 mb-md-0 align-items-center text-center">
		    		<a class="navbar-brand" href="index.jsp">Dentista<span>Dental Clinic</span></a>
	    		</div>
			...
			<div class="container">
		        ...
		        <table align="center">
					<tr>
					 ...
					 <td><span style="font-size:22px; color: red">Insurance Section</span></td>
					 </tr>
            	</table><br>
				<%-- <%
				...
				<tr align="center">
					<th colspan="2"><b>To View Patients Checkup Reports</b></th>  
				</tr>	
				<tr align="center">

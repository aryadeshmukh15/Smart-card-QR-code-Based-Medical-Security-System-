...
<!DOCTYPE html>
  ...
  <%
	  ...
	  if(request.getParameter("upload")!=null){
		   out.println("<script>alert('Patients Records Uploaded Successfully.......!!');</script>"); 
	  }
	%>
    <header id="header">
           ...
           <table align="center" border="10" cellpadding="10px" cellspacing="0px">
				...
				%>
					<tr align="center">
						...
						<td colspan="3"><span style="font-size:20px; color: red">Mr./Ms. <b><%=rs.getString("pfname") %>&nbsp;<%=rs.getString("plname") %>'s</b> Personal History </span></td>
					</tr>
		            <tr align="center">
					...
					<tr align="center">
					<th rowspan="2"><b>Registration Date</b></th>
						<td rowspan="2"><%=rs.getString("regDate") %></td>
					<th rowspan="2"><b>Action</b></th>
						<td><button class="button"><a href="Treatment.jsp"><font color="black"><b>CheckUp</b></font></a></button></td>
					</tr>
					<tr align="center">
						<td><button class="button"><a href="Prescriptions.jsp"><font color="black"><b>Prescriptions</b></font></a></button></td>
					</tr>
					
					<tr align="center">
					<th><b>Uploads</b></th>
						<td colspan="2"><button class="button"><a href="Uploads.jsp"><font color="black"><b>Upload Prescriptions</b></font></a></button></td>
						<td><button class="button"><a href="Uploads1.jsp"><font color="black"><b>Upload CheckUp</b></font></a></button></td>
					</tr>
            <%
				}
			%>

     ...
     <header id="header">
			...
			<section class="appointment-area">			
				<div class="container">
					...
					<%-- <h2>Welcome <%=session.getAttribute("username") %> to Doctor Section</h2>	<br> --%>
		        <table align="center">
					<tr>
					 <td>
				...
				<h3 align="center">"Medicine is not a science; it is empiricism founded on a network of blunders"
				<br>
				<button class="button" align="center"><a href="PatientsPres.jsp"><font color="black"><b>Patients Prescriptions</b></font></a></button>
					</h3>
				</div>
		</div>
		</div>	

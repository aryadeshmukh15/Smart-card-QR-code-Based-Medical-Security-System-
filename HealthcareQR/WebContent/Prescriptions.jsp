    ...
    <header id="header">
           ...
           <table align="center" border="10" cellpadding="10px" cellspacing="0px">
				...
				%>
					...
					<tr align="center">
					<th><b>Tablets</b></th>  
						<td><input type="text" name="tab" style="width:100px;" required></td>
					<th><b>Syrup</b></th>   
						<td><input type="text" name="syrup" style="width:100px;" required></td>
					</tr>
					
					<tr align="center">
					<th><b>Tablets</b></th>  
						<td><input type="text" name="taba" style="width:100px;" required></td>
					<th><b>Syrup</b></th>   
						<td><input type="text" name="syrupa" style="width:100px;" required></td>
					</tr>
					
					<tr align="center">
					<th><b>Lotion</b></th>  
						<td><input type="text" name="cleaner" style="width:100px;" required></td>
					<th><b>Cream</b></th>   
						<td><input type="text" name="clips" style="width:100px;" required></td>
					</tr>

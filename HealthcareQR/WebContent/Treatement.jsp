    ...
    <header id="header">
			...
			<table align="center">
				...
				<td>
				 ...
				 <td><span style="font-size:22px; color: red">Welcome to Doctor Section</span></td>
				 </tr>
            </table><br>
            <%
            ...
            <table style="border: 3px solid red" align="center" border="10" width="350px" height="50px" cellpadding="10px">
					<tr align="center" class="noBorder">
						<td><span style="font-size:22px; color: red">QR Code</span></td>						
						<td rowspan="2"><img src="images/patient.jpg" width="60px;" height="60px"></td>
					</tr> 
					<tr>
						<td align="center"><input type="text" name="SmartCardNo" value="<%=session.getAttribute("SmartCardNo") %>" style="height: 32px; width:142px;"></td>
					</tr>
					<tr class="noBorder">	
					 	<td align="center"><input type="file" name="username" id="username" required></td>
        				<td><input class="button" type="submit" value="Scan QR Code" style="height: 32px; width:142px;"></td>
					 </tr>
            		</table>
            	</form>	
</div>

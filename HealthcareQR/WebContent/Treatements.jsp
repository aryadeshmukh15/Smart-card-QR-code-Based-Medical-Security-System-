    ...
    <header id="header">
			...
			<table align="center">
				...
				<td>
				 ...
				 <td><span style="font-size:22px; color: red">View Treatements</span></td>
				 </tr>
            </table><br>
            		<%
            ...
            <table style="border: 3px solid red" align="center" border="10" width="350px" height="50px" cellpadding="10px">
					...
					<tr class="noBorder">	
					 	<td><button class="button"><a href="" onClick='window.open(src="Uploads/<%= rs.getString("prescription") %>")' title="Click to Open"><font color="black"><b>View Prescription File</b></font></a></button></td>
					 	<td><button class="button"><a href="" onClick='window.open(src="Uploads/<%= rs.getString("checkup") %>")' title="Click to Open"><font color="black"><b>View Checkup File</b></font></a></button></td>
					</tr>
					<%} %>
            </table>
		  </div>

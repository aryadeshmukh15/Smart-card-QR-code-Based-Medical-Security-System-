    ...
    <header id="header">
			...
			<table align="center">
				...
				<td>
				 ...
				 <td><span style="font-size:22px; color: red">View Your Appointments</span></td>
				 </tr>
            </table><br>
            ...
            <table style="border: 3px solid red" align="center" border="10" width="350px" height="50px" cellpadding="10px">
            		<%		
						...
						PreparedStatement ps=con.prepareStatement("select * from appointment where SmartCardNo=?");
					...
					<tr align="center" class="noBorder">
						...
						<td><a href="EditPPic.jsp"><img src="QRCode/<%=username%>.png" width="60px;" height="60px"></a></td>
					</tr> 
					<tr class="noBorder">	
					 	<td align="center"><b>Date: </b></td>
					 	<td align="center"><b>Time: </b></td>
					 	<td align="center"><b>Status: </b></td>
					 	<td align="center"><b>Assign Doctor: </b></td>
					</tr>
					<tr class="noBorder">	
					 	<td align="center"><b><%=rs.getString("apdate") %></b></td>
					 	<td align="center"><b><%=rs.getString("aptime") %></b></td>
					 	<td align="center"><b><%=rs.getString("status") %></b></td>
					 	<td align="center"><b><%=rs.getString("doctor") %></b></td>
					</tr>
					<%
				}
			%>

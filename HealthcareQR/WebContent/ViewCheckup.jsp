  ...
  <body>
     ...
     <header id="header">
           ...
           <table align="center" border="10" cellpadding="10px" cellspacing="0px">
				...
				%>
		            <tr>
		            	<th colspan="2"><b>Patients Checkup Records</b></th>
		            	<td rowspan="4"><img src="images/HealthInsu.png" width="180px" height="180px" style="border-radius: 70%;"></td>
		            </tr>
		            <tr align="center">
					...
					<tr>
						<td><button class="button"><a href="Download1?checkup=<%= rs.getString("checkup") %>"><font color="black"><b>Download</b></font></a></button></td>
						<td><button class="button"><a href="" onClick='window.open(src="Uploads/<%= rs.getString("checkup") %>")' title="Click to Open"><font color="black"><b>View</b></font></a></button></td>
					</tr>
					<tr>
						<th colspan="3"><button class="button"><a href="InsurancePlan.jsp"><font color="black"><b>Insurance Plan</b></font></a></button></th>
					</tr>

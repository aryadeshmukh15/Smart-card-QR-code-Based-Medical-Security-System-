     ...
     <header id="header">
          ...
          <!--  <form action="Prescription" method="post"> -->
           <table align="center" border="10" cellpadding="10px" cellspacing="0px">
				...
				%>
		            <tr>
		            	<th colspan="2"><b>Patients Prescription</b></th>
		            	<td rowspan="4"><img src="images/ph5.jpg" width="180px" height="180px" style="border-radius: 70%;"></td>
		            </tr>
		            <tr align="center">
					...
					<tr>
						<td><button class="button"><a href="Download?prescription=<%= rs.getString("prescription") %>"><font color="black"><b>Download</b></font></a></button></td>
						<td><button class="button"><a href="" onClick='window.open(src="Uploads/<%= rs.getString("prescription") %>")' title="Click to Open"><font color="black"><b>View</b></font></a></button></td>
					</tr>
					
					<%-- <%
					response.setHeader("Content-Type", "QRCode/pdf");
					response.setHeader("Content-Disposition", "attachment; QRCode=\"" + "prescription.pdf" + "\"");
					%> --%>
            <%
				}
			%>

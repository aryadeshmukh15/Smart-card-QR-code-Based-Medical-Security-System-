...
public class PatientQRCode extends HttpServlet {
    ...
    private void processRequest(HttpServletRequest request,
    	...
    	try{
    		...
    		String filePath = "D:\\CRSTesting\\HealthcareQR\\WebContent\\QRCode\\";
             ...
             if(rs1.next())
             {
                 ...
                 if(r>0){
                    ...
                    String host = "smtp.gmail.com";
                     String port = "587";
                    String mailFrom = "project.varification@gmail.com";
                    String pass = "Email@123";
                     ...
                     attachFiles[0] = "D:\\CRSTesting\\HealthcareQR\\WebContent\\QRCode\\"+username+".png";

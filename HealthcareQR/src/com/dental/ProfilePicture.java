...
public class ProfilePicture extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		try 
		{
			...
			File file = uploadFile(fileItem,"D:\\CRSTesting\\Dentista1\\WebContent\\ProfilePicture");
			...
			PreparedStatement ps=con.prepareStatement("update patient set ppicture=? where id=?");

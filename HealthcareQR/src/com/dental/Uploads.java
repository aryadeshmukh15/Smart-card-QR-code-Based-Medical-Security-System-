...
public class Uploads extends HttpServlet {
	...
	Connection con = null;
	final String UPLOAD_DIRECTORY = "D:\\QRCode";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		if (ServletFileUpload.isMultipartContent(request)) 
		{
			try 
			{
				...
				System.out.println("FileName " + prescription);
				System.out.println("File Extension " + FileExtention);
				System.out.println("File Size " + FileSize);
			
					try {
						 PreparedStatement ps =con.prepareStatement("INSERT INTO `uploads` (`id`, `SmartCardNo`, `username`, `prescription`) VALUES (NULL,'"+SmartCardNo+"','"+username+"','"+prescription+"')");
